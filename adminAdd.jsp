<%-- 
    Document   : adminAdd
    Created on : May 26, 2023, 1:03:45 AM
    Author     : Shahjahan Akbar
--%>

<%@page contentType="text/html" import="classes.*,java.sql.*,java.util.*" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form action="adminAdd.jsp" method="post">
            ...
            <div class="formcontainer">
                ...
                <button type="submit" name="Insert">Add Admin</button>
        </form>
